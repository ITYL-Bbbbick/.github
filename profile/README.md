...
### 데이터베이스
- mySQL : 8.0.39
- MockData 저장하여 실제 서비스 환경에 가깝게 구현하고자 시도
  - 구성한 데이터 현황: 
